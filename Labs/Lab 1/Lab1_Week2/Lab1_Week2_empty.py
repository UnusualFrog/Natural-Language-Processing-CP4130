...
#NOTE: Source had to be included for add_pipe, otherwise code throws initialization errors
...
# POS Tagger/tagger
# Each token is matched correctly to its part of speech such as 'morning' as a noun or 'Whitmore' as a proper noun
pos_tokens = []
for token in doc:
    pos_tokens.append(f"{token}: {token.pos_}")
print("POS results: ")
...
# Forces the text "Hampshire" to be recognized by POS tagging as an adjective, rather than a propernoun
...
# Hampshire becomes recognized as an adjective
